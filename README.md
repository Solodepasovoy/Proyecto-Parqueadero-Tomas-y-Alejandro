...
**Paso 1**
Ve a la subcarpeta "src" dentro de la carpeta del parqueadero.
**Paso 2**
Haz clic derecho, abre gitbash y coloca en la terminal de gitbash "g++ main.cpp -pthread -o a.exe".
**Paso 3**
Correlo con "./a.exe"